...
const FaqItem = ({ item, index }) => {
  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      <div
        className={clsx(
          "g5 -bottom-7 -top-7 start-0 end-0 -z-1 rounded-3xl opacity-0 transition-opacity duration-500 absolute",
          active && "opacity-100",
        )}
      >
        <div className="g4 absolute inset-0.5 -z-1 rounded-3xl" />
        <div className="absolute start-8 top-0 h-0.5 w-40 bg-p1" />
      </div>
    </div>
  );
};
